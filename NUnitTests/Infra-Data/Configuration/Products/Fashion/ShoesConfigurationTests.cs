...
namespace NUnitTests.Infra_Data.Configuration.Products.Fashion;
...
public class ShoesConfigurationTests
{
    ...
    public void Should_Configure_Shoes()
    {
        ...
        Assert.Equal("Leather", shoe9.MaterialObjectValue?.MaterialFromAbroad);
        ...
        Assert.Equal("Leather", shoe10.MaterialObjectValue?.MaterialFromAbroad);
    }
}