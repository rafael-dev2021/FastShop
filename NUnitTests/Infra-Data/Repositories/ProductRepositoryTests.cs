...
namespace NUnitTests.Infra_Data.Repositories;
...
public class ProductRepositoryTests
{
    ...
    public async Task GetProductsFavoritesAsync_ShouldReturnFavoriteProducts()
    {
        ...
        Assert.Contains(collection, p => p is { Name: "Product1", FlagsObjectValue.IsFavorite: true });
    }
    ...
    public async Task GetProductsBestSellersAsync_ShouldReturnBestSellerProducts()
    {
        ...
        var collection = result as Product[] ?? result.ToArray();
        Assert.Single(collection);
        Assert.Contains(collection, p => p is { Name: "Product1", FlagsObjectValue.IsBestSeller: true });
    }
