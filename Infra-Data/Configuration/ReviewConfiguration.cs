...
public class ReviewConfiguration : IEntityTypeConfiguration<Review>
{
    public void Configure(EntityTypeBuilder<Review> builder)
    {
        ...
        var reviewDate = new DateTime(2025, 02, 2); 

        builder.HasData(
            new Review(1, "The quality of the photos is incredible.",
                "https://http2.mlstatic.com/D_NQ_NP_637616-MLA70484274053_072023-O.webp", 5, reviewDate, 1),
            new Review(2,
                ...
                "https://m.media-amazon.com/images/I/71a4vqXqxbL._SY256.jpg", 5, reviewDate, 1),
            ...
            new Review(4,
                ...
                "https://http2.mlstatic.com/D_NQ_NP_2X_936910-MLA54765476953_032023-F.webp", 5, reviewDate, 2),
            new Review(5, "Excellent, after all it is an Apple product. Worth every penny given ❤.",
                "https://http2.mlstatic.com/D_NQ_NP_2X_960098-MLA73264672831_122023-F.webp", 5, reviewDate, 3),
            ...
            new Review(7, "New original product you can buy without fear!.",
                "https://http2.mlstatic.com/D_NQ_NP_2X_696237-MLA71736945652_092023-F.webp", 5, reviewDate, 5),
            new Review(8, "Excellent product, came sealed.",
                "https://http2.mlstatic.com/D_NQ_NP_2X_918056-MLA72166744514_102023-F.webp", 5, reviewDate, 5),
            new Review(9, "Perfect product.",
                "https://http2.mlstatic.com/D_NQ_NP_2X_661229-MLA72108620029_102023-F.webp", 5, reviewDate, 6),
            new Review(10, "The best product, very good!",
                "https://http2.mlstatic.com/D_NQ_NP_2X_942915-MLA54965635426_042023-F.webp", 4, reviewDate, 6),
            new Review(11, "Pay attention to size. Nike models are smaller. The ideal is to buy 1 size larger.", "", 4,
                reviewDate, 7),
            new Review(12, "It was small on me. I want to return it. To get my refund.", "", 1, reviewDate, 7),
            new Review(13, "Excellent product.", "", 5, reviewDate, 9),
            new Review(14, "I liked the original, it has to be laced but it\'s perfect.", "", 5, reviewDate, 10),
