...
public class ShoesConfiguration : IEntityTypeConfiguration<Shoes>
{
    ...
    private static void ConfigureSpecificationsOv(EntityTypeBuilder<Shoes> builder)
    {
    ...
    private static void ConfigurePriceOv(EntityTypeBuilder<Shoes> builder)
    {
    ...
    private static void ConfigureWarrantyOv(EntityTypeBuilder<Shoes> builder)
    {
    ...
    private static void ConfigureFlagsOv(EntityTypeBuilder<Shoes> builder)
    {
    ...
    private static void ConfigureDataOv(EntityTypeBuilder<Shoes> builder)
    {
    ...
    private static void ConfigureCommonPropertiesOv(EntityTypeBuilder<Shoes> builder)
    {
    ...
    private static void ConfigureShoesMaterialsOv(EntityTypeBuilder<Shoes> builder)
    {
        builder.OwnsOne(x => x.MaterialObjectValue,
            sa =>
            {
                sa.Property(x => x.MaterialFromAbroad)
                    .HasMaxLength(10)
                    .IsRequired();
                sa.Property(x => x.MaterialInterior)
                    .HasMaxLength(10);
                sa.Property(x => x.MaterialSole)
                    .HasMaxLength(10);
                sa.Property<int>("Id");
                sa.HasKey("Id");
                sa.HasData(new
                {
                    Id = 9,
                    MaterialFromAbroad = "Leather",
                    MaterialInterior = "Cotton",
                    MaterialSole = "Rubber",
                });
                sa.HasData(new
                {
