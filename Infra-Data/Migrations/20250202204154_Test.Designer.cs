...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.Category", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Image = "https://i5.walmartimages.com/seo/Straight-Talk-Apple-iPhone-12-64GB-Black-Prepaid-Smartphone-Locked-to-Straight-Talk_66b2853b-6cb5-4f20-b73a-b60b39b6de44.6b3bf83a920058a47342318925f1dc2b.jpeg?odnHeight=640&odnWidth=640&odnBg=FFFFFF",
                            IsActive = true,
                            Name = "Smartphones"
                        },
                        new
                        {
                            Id = 2,
                            Image = "https://i5.walmartimages.com/seo/Reebok-Women-s-Flight-Jogger-with-Cargo-Pockets_eefde8e0-c787-48fc-962e-2d2d406391a1.70bc369116e0b1954b5eee14c1a67ea7.jpeg?odnHeight=640&odnWidth=640&odnBg=FFFFFF",
                            IsActive = true,
                            Name = "Fashion"
                        },
                        new
                        {
                            Id = 3,
                            Image = "https://i5.walmartimages.com/seo/Xbox-Series-X-Video-Game-Console-Black_9f8c06f5-7953-426d-9b68-ab914839cef4.5f15be430800ce4d7c3bb5694d4ab798.jpeg?odnHeight=640&odnWidth=640&odnBg=FFFFFF",
                            IsActive = true,
                            Name = "Games"
                        },
                        new
                        {
                            Id = 4,
                            Image = "https://i5.walmartimages.com/seo/Carote-Nonstick-Pots-and-Pans-Set-10-Pcs-Granite-Stone-Kitchen-Cookware-Sets-White_efe69ee7-6273-4cbe-a436-149b7b1d0d0c.a2320ff6519d540c3df326c48fdef207.png?odnHeight=2000&odnWidth=2000&odnBg=FFFFFF",
                            IsActive = true,
                            Name = "Kitchen"
                        },
                        new
                        {
                            Id = 5,
                            Image = "https://i5.walmartimages.com/seo/Friendship-Bracelet-Making-Kit-Girls-DIY-Craft-Kits-Toys-Cool-Arts-Crafts-Teen-Travel-Activity-Set-Gifts-Age-6-7-8-9-10-11-12-Year-Old_1c074238-f765-4bc9-bcd4-6aec3c63e831.61da6ea6dec87564dbe3452ae6d55039.jpeg?odnHeight=640&odnWidth=640&odnBg=FFFFFF",
                            IsActive = true,
                            Name = "Kids"
                        },
                        new
                        {
                            Id = 6,
                            Image = "https://i5.walmartimages.com/seo/Acer-Nitro-31-5-1500R-Curved-Full-HD-1920-x-1080-Gaming-Monitor-Black-ED320QR-S3biipx_026e53ed-7591-4f39-afb1-d5575a7fc06a.fae36db73738179d935b7d5e64a5be51.jpeg?odnHeight=640&odnWidth=640&odnBg=FFFFFF",
                            IsActive = true,
                            Name = "Electronic"
                        },
                        new
                        {
                            Id = 7,
                            Image = "https://i5.walmartimages.com/seo/Intex-Corner-Sofa_b6271dd9-4704-436a-aa35-36293fa7482c_1.887862bad366185f36f3793d387c450e.jpeg?odnHeight=640&odnWidth=640&odnBg=FFFFFF",
                            IsActive = true,
                            Name = "Furniture"
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.Reviews.Review", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ProductId = 1,
                            Rating = 5,
                            ReviewDate = new DateTime(2025, 2, 2, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            Id = 2,
            ...
            modelBuilder.Entity("Domain.Entities.Products.Fashion.F_Shoes.Shoes", b =>
                {
            ...
            modelBuilder.Entity("Domain.Entities.Products.Fashion.F_TShirt.Shirt", b =>
                {
                    b.HasBaseType("Domain.Entities.Product");
            ...
            modelBuilder.Entity("Domain.Entities.Products.Technology.T_Games.Game", b =>
                {
                    b.HasBaseType("Domain.Entities.Product");
            ...
            modelBuilder.Entity("Domain.Entities.Products.Technology.T_Smartphones.Smartphone", b =>
                {
                    b.HasBaseType("Domain.Entities.Product");
            ...
            modelBuilder.Entity("Domain.Entities.Products.Fashion.F_Shoes.Shoes", b =>
                {
                    b.OwnsOne("Domain.Entities.Products.Fashion.F_Shoes.ObjectValues.MaterialObjectValue", "MaterialObjectValue", b1 =>
                        {
                            b1.Property<int>("Id")
                                .HasColumnType("int");

                            b1.Property<string>("MaterialFromAbroad")
                                .IsRequired()
                                .HasMaxLength(10)
                                .HasColumnType("nvarchar(10)");

                            b1.Property<string>("MaterialInterior")
                                .IsRequired()
                                .HasMaxLength(10)
                                .HasColumnType("nvarchar(10)");

                            b1.Property<string>("MaterialSole")
                                .IsRequired()
                                .HasMaxLength(10)
                                .HasColumnType("nvarchar(10)");
                    ...
                    b.OwnsOne("Domain.Entities.ObjectValues.ProductObjectValue.CommonPropertiesObjectValue", "CommonPropertiesObjectValue", b1 =>
                        {
                            ...
                            b1.Property<string>("RecommendedUser")
                                .IsRequired()
                                .ValueGeneratedOnUpdateSometimes()
                                .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Domain.Entities.Products.Fashion.F_TShirt.Shirt", b =>
                {
                    b.OwnsOne("Domain.Entities.Products.Fashion.F_TShirt.ObjectValues.MainFeaturesObjectValue", "MainFeaturesObjectValue", b1 =>
                        {
                            b1.Property<int>("Id")
                                .HasColumnType("int");
                    ...
                    b.OwnsOne("Domain.Entities.Products.Fashion.F_TShirt.ObjectValues.OtherFeaturesObjectValue", "OtherFeaturesObjectValue", b1 =>
                        {
                            b1.Property<int>("Id")
                                .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Entities.Products.Technology.T_Games.Game", b =>
                {
                    ...
                    b.OwnsOne("Domain.Entities.Products.Technology.T_Games.ObjectValues.GeneralFeaturesObjectValue", "GeneralFeaturesObjectValue", b1 =>
                        {
                            b1.Property<int>("Id")
                                .HasColumnType("int");
                    ...
                    b.OwnsOne("Domain.Entities.Products.Technology.T_Games.ObjectValues.MediaSpecificationObjectValue", "MediaSpecificationObjectValue", b1 =>
                        {
                            b1.Property<int>("Id")
                                .HasColumnType("int");
                    ...
                    b.OwnsOne("Domain.Entities.Products.Technology.T_Games.ObjectValues.RequirementObjectValue", "RequirementObjectValue", b1 =>
                        {
                            b1.Property<int>("Id")
                                .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Entities.Products.Technology.T_Smartphones.Smartphone", b =>
                {
                    b.OwnsOne("Domain.Entities.Products.Technology.T_Smartphones.ObjectValues.BatteryObjectValue", "BatteryObjectValue", b1 =>
                        {
                            b1.Property<int>("Id")
                                .HasColumnType("int");
                    ...
                    b.OwnsOne("Domain.Entities.Products.Technology.T_Smartphones.ObjectValues.CameraObjectValue", "CameraObjectValue", b1 =>
                        {
                            b1.Property<int>("Id")
                                .HasColumnType("int");
                    ...
                    b.OwnsOne("Domain.Entities.Products.Technology.T_Smartphones.ObjectValues.DimensionObjectValue", "DimensionObjectValue", b1 =>
                        {
                            b1.Property<int>("Id")
                                .HasColumnType("int");
                    ...
                    b.OwnsOne("Domain.Entities.Products.Technology.T_Smartphones.ObjectValues.DisplayObjectValue", "DisplayObjectValue", b1 =>
                        {
                            b1.Property<int>("Id")
                                .HasColumnType("int");
                    ...
                    b.OwnsOne("Domain.Entities.Products.Technology.T_Smartphones.ObjectValues.FeatureObjectValue", "FeatureObjectValue", b1 =>
                        {
                            b1.Property<int>("Id")
                                .HasColumnType("int");
                    ...
                    b.OwnsOne("Domain.Entities.Products.Technology.T_Smartphones.ObjectValues.PlatformObjectValue", "PlatformObjectValue", b1 =>
                        {
                            b1.Property<int>("Id")
                                .HasColumnType("int");
                    ...
                    b.OwnsOne("Domain.Entities.Products.Technology.T_Smartphones.ObjectValues.StorageObjectValue", "StorageObjectValue", b1 =>
                        {
                            b1.Property<int>("Id")
                                .HasColumnType("int");
