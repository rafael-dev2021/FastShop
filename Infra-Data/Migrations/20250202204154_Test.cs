        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Payment_Card_CreditCardId",
                        column: x => x.CreditCardId,
                        principalTable: "Card",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Payment_Card_DebitCardId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ImagesUrl = table.Column<string>(type: "nvarchar(900)", maxLength: 900, nullable: false),
                    ...
                    FlagsObjectValue_IsFavorite = table.Column<bool>(type: "bit", nullable: true, defaultValue: false),
                    FlagsObjectValue_IsDailyOffer = table.Column<bool>(type: "bit", nullable: true, defaultValue: false),
                    FlagsObjectValue_IsBestSeller = table.Column<bool>(type: "bit", nullable: true, defaultValue: false),
                    ...
                    SpecificationObjectValue_Type = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                    WarrantyObjectValue_WarrantyLength = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: true),
                    WarrantyObjectValue_WarrantyInformation = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: true),
                    Discriminator = table.Column<string>(type: "nvarchar(13)", maxLength: 13, nullable: false),
                    MaterialObjectValue_MaterialFromAbroad = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: true),
                    MaterialObjectValue_MaterialInterior = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: true),
                    MaterialObjectValue_MaterialSole = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: true),
                    CommonPropertiesObjectValue_Gender = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CommonPropertiesObjectValue_Color = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CommonPropertiesObjectValue_Age = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CommonPropertiesObjectValue_RecommendedUser = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CommonPropertiesObjectValue_Size = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    DisplayObjectValue_DisplayType = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: true),
            ...
            migrationBuilder.InsertData(
                table: "Categories",
                columns: new[] { "Id", "Image", "IsActive", "Name" },
                values: new object[,]
                {
                    { 1, "https://i5.walmartimages.com/seo/Straight-Talk-Apple-iPhone-12-64GB-Black-Prepaid-Smartphone-Locked-to-Straight-Talk_66b2853b-6cb5-4f20-b73a-b60b39b6de44.6b3bf83a920058a47342318925f1dc2b.jpeg?odnHeight=640&odnWidth=640&odnBg=FFFFFF", true, "Smartphones" },
            ...
            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "Id", "DataObjectValue_ReleaseMonth", "DataObjectValue_ReleaseYear", "FlagsObjectValue_IsDailyOffer", "FlagsObjectValue_IsFavorite", "PriceObjectValue_HistoryPrice", "PriceObjectValue_Price", "SpecificationObjectValue_Brand", "SpecificationObjectValue_Line", "SpecificationObjectValue_Model", "SpecificationObjectValue_Type", "SpecificationObjectValue_Weight", "WarrantyObjectValue_WarrantyInformation", "WarrantyObjectValue_WarrantyLength", "BatteryObjectValue_BatteryCapacityMAh", "BatteryObjectValue_BatteryType", "BatteryObjectValue_IsBatteryRemovable", "CameraObjectValue_MainCameraFeature", "CameraObjectValue_MainCameraSpec", "CameraObjectValue_SelfieCameraFeature", "CameraObjectValue_SelfieCameraSpec", "DimensionObjectValue_HeightInches", "DimensionObjectValue_ThicknessInches", "DimensionObjectValue_WidthInches", "DisplayObjectValue_DisplayProtection", "DisplayObjectValue_DisplayResolution", "DisplayObjectValue_DisplaySizeInches", "DisplayObjectValue_DisplayType", "FeatureObjectValue_CellNetworkTechnology", "FeatureObjectValue_ManufacturerPartNumber", "FeatureObjectValue_VirtualAssistant", "PlatformObjectValue_Chipset", "PlatformObjectValue_Cpu", "PlatformObjectValue_Gpu", "PlatformObjectValue_OperatingSystem", "StorageObjectValue_RamGb", "StorageObjectValue_StorageGb", "CategoryId", "Description", "Discriminator", "ImagesUrl", "Name", "Stock", "CommonPropertiesObjectValue_Age", "CommonPropertiesObjectValue_Color", "CommonPropertiesObjectValue_Gender", "CommonPropertiesObjectValue_RecommendedUser", "CommonPropertiesObjectValue_Size" },
                values: new object[,]
                {
                    { 1, "June", 2023, true, true, 2299.99m, 2179.99m, "Samsung", "Galaxy S", "S23 Ultra", "Smartphone", "233 g", "30-Day Limited Warranty", "1-year warranty", 5000, "Li-Ion", false, "(Quad) 200 MP + 10 MP + 10 MP + 12 MP", "200 Mpx", "LED flash, auto-HDR, panorama", "12 Mpx", 163.40000000000001, 8.9000000000000004, 78.099999999999994, "Corning Gorilla Glass Victus 2", "1440 px x 3088 px", 6.7999999999999998, "Dynamic AMOLED 2X 120 Hz", "WCDMA (UMTS) / GSM / 5G", "SM-S918UZKFXAA", "Samsung Bixby,Alexa,Google Assistant", "Qualcomm SM8550-AC Snapdragon 8 Gen 2", "Octa-core", "Adreno 740", "Android", 12, 512, 1, "Maximum security so that only you can access your team. You can choose between the fingerprint sensor to activate your phone with a tap, or facial recognition that allows you to unlock up to 30% faster.", "Smartphone", "[\"https://http2.mlstatic.com/D_NQ_NP_856672-MLU70401529412_072023-O.webp\",\"https://http2.mlstatic.com/D_NQ_NP_945544-MLU70401529414_072023-O.webp\",\"https://http2.mlstatic.com/D_NQ_NP_808604-MLU70400221716_072023-O.webp\",\"https://http2.mlstatic.com/D_NQ_NP_827555-MLU70400783806_072023-O.webp\"]", "Samsung Galaxy S23 Ultra 512GB Unlocked - Black", 20, "", "Phantom Black", "", "", "" },
                    { 2, "August", 2022, true, true, 2199.99m, 1624.99m, "Samsung", "Galaxy S", "S23 Ultra", "Smartphone", "235 g", "30-Day Limited Warranty", "1-year warranty", 5000, "Lithium Ion", false, "200 Mpx/12 Mpx/10 Mpx/10 Mpx", "200 Mpx", "LED flash, auto-HDR, panorama", "12 Mpx", 163.40000000000001, 8.9000000000000004, 78.099999999999994, "Corning Gorilla Glass Victus 2", "1440 px x 3088 px", 6.7999999999999998, "Dynamic AMOLED 2X", "WCDMA (UMTS) / GSM / 5G", "SM-B518UZKFX22", "Samsung Bixby,Alexa,Google Assistant", "Qualcomm SM8550-AC Snapdragon 8 Gen 2", "Octa-Core of up to 3.36GHz", "Adreno 740", "Android", 8, 258, 1, "Maximum security so that only you can access your team. You can choose between the fingerprint sensor to activate your phone with a tap, or facial recognition that allows you to unlock up to 30% faster.", "Smartphone", "[\"https://http2.mlstatic.com/D_NQ_NP_683947-MLU73106437489_112023-O.webp\",\"https://http2.mlstatic.com/D_NQ_NP_690989-MLU72932986551_112023-O.webp\",\"https://http2.mlstatic.com/D_NQ_NP_612226-MLU72932986555_112023-O.webp\",\"https://http2.mlstatic.com/D_NQ_NP_683459-MLU72932986549_112023-O.webp\"]", "Samsung Galaxy S23 Ultra 256GB - Violet", 25, "", "Violet", "", "", "" }
                });

            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "Id", "DataObjectValue_ReleaseMonth", "DataObjectValue_ReleaseYear", "FlagsObjectValue_IsDailyOffer", "PriceObjectValue_HistoryPrice", "PriceObjectValue_Price", "SpecificationObjectValue_Brand", "SpecificationObjectValue_Line", "SpecificationObjectValue_Model", "SpecificationObjectValue_Type", "SpecificationObjectValue_Weight", "WarrantyObjectValue_WarrantyInformation", "WarrantyObjectValue_WarrantyLength", "BatteryObjectValue_BatteryCapacityMAh", "BatteryObjectValue_BatteryType", "BatteryObjectValue_IsBatteryRemovable", "CameraObjectValue_MainCameraFeature", "CameraObjectValue_MainCameraSpec", "CameraObjectValue_SelfieCameraFeature", "CameraObjectValue_SelfieCameraSpec", "DimensionObjectValue_HeightInches", "DimensionObjectValue_ThicknessInches", "DimensionObjectValue_WidthInches", "DisplayObjectValue_DisplayProtection", "DisplayObjectValue_DisplayResolution", "DisplayObjectValue_DisplaySizeInches", "DisplayObjectValue_DisplayType", "FeatureObjectValue_CellNetworkTechnology", "FeatureObjectValue_ManufacturerPartNumber", "FeatureObjectValue_VirtualAssistant", "PlatformObjectValue_Chipset", "PlatformObjectValue_Cpu", "PlatformObjectValue_Gpu", "PlatformObjectValue_OperatingSystem", "StorageObjectValue_RamGb", "StorageObjectValue_StorageGb", "CategoryId", "Description", "Discriminator", "ImagesUrl", "Name", "Stock", "CommonPropertiesObjectValue_Age", "CommonPropertiesObjectValue_Color", "CommonPropertiesObjectValue_Gender", "CommonPropertiesObjectValue_RecommendedUser", "CommonPropertiesObjectValue_Size" },
                values: new object[] { 3, "Februery", 2023, true, 2199.99m, 2035.99m, "Apple", "iPhone", "iPhone 15 Pro", "Smartphone", "235 g", "30-Day Limited Warranty", "1-year warranty", 5000, "Lithium Ion", false, "48 Mpx/12 Mpx/12 Mpx", "48 Mpx", "Photonic engine, Deep fusion, Smart HDR 4, Portrait mode, Portrait lighting with six effects,", "12 Mpx", 160.90000000000001, 7.7999999999999998, 77.799999999999997, "Corning Gorilla Glass Victus 2", "2556 px x 1179 px", 6.0999999999999996, "Super Retina XDR", "WCDMA (UMTS) / GSM / 5G", "AA-12SF7832SD301EW3", "Apple Watch,HomePod,Siri Assistant", "Apple A17 Pro", "Chip A16 Bionic", "5 cores", "iOS", 8, 512, 1, "FORGED FROM TITANIUM — iPhone 15 Pro features a rugged, lightweight design made from aerospace-grade titanium. On the back, textured matte glass and, on the front, Ceramic Shield, more resistant than any smartphone glass. It's also tough against splashes, water, and dust.", "Smartphone", "[\"https://http2.mlstatic.com/D_NQ_NP_918178-MLA71783088444_092023-O.webp\",\"https://http2.mlstatic.com/D_NQ_NP_918178-MLA71783088444_092023-O.webp\",\"https://http2.mlstatic.com/D_NQ_NP_829742-MLA71783365702_092023-O.webp\",\"https://http2.mlstatic.com/D_NQ_NP_715495-MLA71783365704_092023-O.webps\"]", "Apple iPhone 15 Pro (512 GB) - Titanium Blue", 15, "", "Titanium Blue", "", "", "" });

            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "Id", "DataObjectValue_ReleaseMonth", "DataObjectValue_ReleaseYear", "FlagsObjectValue_IsDailyOffer", "FlagsObjectValue_IsFavorite", "PriceObjectValue_HistoryPrice", "PriceObjectValue_Price", "SpecificationObjectValue_Brand", "SpecificationObjectValue_Line", "SpecificationObjectValue_Model", "SpecificationObjectValue_Type", "SpecificationObjectValue_Weight", "WarrantyObjectValue_WarrantyInformation", "WarrantyObjectValue_WarrantyLength", "BatteryObjectValue_BatteryCapacityMAh", "BatteryObjectValue_BatteryType", "BatteryObjectValue_IsBatteryRemovable", "CameraObjectValue_MainCameraFeature", "CameraObjectValue_MainCameraSpec", "CameraObjectValue_SelfieCameraFeature", "CameraObjectValue_SelfieCameraSpec", "DimensionObjectValue_HeightInches", "DimensionObjectValue_ThicknessInches", "DimensionObjectValue_WidthInches", "DisplayObjectValue_DisplayProtection", "DisplayObjectValue_DisplayResolution", "DisplayObjectValue_DisplaySizeInches", "DisplayObjectValue_DisplayType", "FeatureObjectValue_CellNetworkTechnology", "FeatureObjectValue_ManufacturerPartNumber", "FeatureObjectValue_VirtualAssistant", "PlatformObjectValue_Chipset", "PlatformObjectValue_Cpu", "PlatformObjectValue_Gpu", "PlatformObjectValue_OperatingSystem", "StorageObjectValue_RamGb", "StorageObjectValue_StorageGb", "CategoryId", "Description", "Discriminator", "ImagesUrl", "Name", "Stock", "CommonPropertiesObjectValue_Age", "CommonPropertiesObjectValue_Color", "CommonPropertiesObjectValue_Gender", "CommonPropertiesObjectValue_RecommendedUser", "CommonPropertiesObjectValue_Size" },
                values: new object[] { 4, "March", 2023, true, true, 1799.99m, 1624.99m, "Apple", "iPhone", "iPhone 15 Pro", "Smartphone", "235 g", "30-Day Limited Warranty", "1-year warranty", 5000, "Lithium Ion", false, "48 Mpx/12 Mpx/12 Mpx", "48 Mpx", "Photonic engine, Deep fusion, Smart HDR 4, Portrait mode, Portrait lighting with six effects,", "12 Mpx", 160.90000000000001, 7.7999999999999998, 77.799999999999997, "Corning Gorilla Glass Victus 2", "2556 px x 1179 px", 6.0999999999999996, "Super Retina XDR", "WCDMA (UMTS) / GSM / 5G", "AA-12VD783HR230SW19", "Apple Watch,HomePod,Siri Assistant", "Apple A17 Pro", "Chip A16 Bionic", "5 cores", "iOS", 8, 128, 1, "FORGED FROM TITANIUM — iPhone 15 Pro features a rugged, lightweight design made from aerospace-grade titanium. On the back, textured matte glass and, on the front, Ceramic Shield, more resistant than any smartphone glass. It's also tough against splashes, water, and dust.", "Smartphone", "[\"https://http2.mlstatic.com/D_NQ_NP_812116-MLA71783168214_092023E-O.webp\",\"https://http2.mlstatic.com/D_NQ_NP_812116-MLA71783168214_092023E-O.webp\",\"https://http2.mlstatic.com/D_NQ_NP_658271-MLA71782871766_092023-O.webp\",\"https://http2.mlstatic.com/D_NQ_NP_998898-MLA71782901894_092023-O.webp\"]", "Apple iPhone 15 Pro (128 GB) - Titanium White", 10, "", "Titanium White", "", "", "" });

            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "Id", "DataObjectValue_ReleaseMonth", "DataObjectValue_ReleaseYear", "FlagsObjectValue_IsBestSeller", "FlagsObjectValue_IsFavorite", "PriceObjectValue_HistoryPrice", "PriceObjectValue_Price", "SpecificationObjectValue_Brand", "SpecificationObjectValue_Line", "SpecificationObjectValue_Model", "SpecificationObjectValue_Type", "SpecificationObjectValue_Weight", "WarrantyObjectValue_WarrantyInformation", "WarrantyObjectValue_WarrantyLength", "CategoryId", "Description", "Discriminator", "ImagesUrl", "Name", "Stock", "CommonPropertiesObjectValue_Age", "CommonPropertiesObjectValue_Color", "CommonPropertiesObjectValue_Gender", "CommonPropertiesObjectValue_RecommendedUser", "CommonPropertiesObjectValue_Size", "GeneralFeaturesObjectValue_Collection", "GeneralFeaturesObjectValue_Developers", "GeneralFeaturesObjectValue_Edition", "GeneralFeaturesObjectValue_GameRating", "GeneralFeaturesObjectValue_Platform", "GeneralFeaturesObjectValue_Publishers", "GeneralFeaturesObjectValue_Saga", "GeneralFeaturesObjectValue_Title", "MediaSpecificationObjectValue_AudioLanguages", "MediaSpecificationObjectValue_FileSize", "MediaSpecificationObjectValue_Format", "MediaSpecificationObjectValue_IsMultiplayer", "MediaSpecificationObjectValue_IsOffline", "MediaSpecificationObjectValue_IsOnline", "MediaSpecificationObjectValue_MaximumNumberOfOfflinePlayers", "MediaSpecificationObjectValue_MaximumNumberOfOnlinePlayers", "MediaSpecificationObjectValue_ScreenLanguages", "MediaSpecificationObjectValue_SubtitleLanguages", "RequirementObjectValue_MinimumGraphicsProcessorsRequired", "RequirementObjectValue_MinimumOperatingSystemsRequired", "RequirementObjectValue_MinimumProcessorsRequired", "RequirementObjectValue_MinimumRamRequirementInMb" },
                values: new object[,]
                {
                    { 5, "June", 2023, true, true, 0.0m, 30.99m, "Sony", "PS5", "Sony", "Video game", "100 g", "30-Day Limited Warranty", "1-year warranty", 3, "With this Spider-Man game you will enjoy hours of fun and new challenges that will allow you to improve as a player.", "Game", "[\"https://http2.mlstatic.com/D_NQ_NP_739971-MLA44963396567_022021-O.webp\",\"https://http2.mlstatic.com/D_NQ_NP_717296-MLA44963321732_022021-O.webp\",\"https://http2.mlstatic.com/D_NQ_NP_902181-MLA44963396568_022021-O.webp\",\"https://http2.mlstatic.com/D_NQ_NP_952087-MLU69953465194_062023-O.webp\"]", "Marvel's Spider-Man: Miles Morales Standard Edition Sony PS5", 10, "", "", "Action", "", "", "Spider man", "Insomniac Games", "Standard Edition", "T", "PS5", "Sony", "30-Day Limited Warranty", "Marvel's Spider-Man: Miles Morales", "English", 60, "Physical", false, true, false, 1, 1, "English, Portuguese", "English, Portuguese", "V", "PS5", "Ps5", 60 },
                    { 6, "July", 2022, true, true, 0.0m, 38.99m, "Sony", "PS5", "Sony", "Video game", "100 g", "30-Day Limited Warranty", "1-year warranty", 3, "With this God of War game you will enjoy hours of fun and new challenges that will allow you to improve as a player. You will be able to share each game with people from all over the world as you can connect online.", "Game", "[\"https://http2.mlstatic.com/D_NQ_NP_834716-MLU72751588558_112023-O.webp\",\"https://http2.mlstatic.com/D_NQ_NP_924074-MLU69483138400_052023-O.webp\",\"https://http2.mlstatic.com/D_NQ_NP_662378-MLU69483138404_052023-O.webp\",\"https://http2.mlstatic.com/D_NQ_NP_852774-MLU69482634062_052023-O.webp\"]", "God of War Ragnarök Standard Edition Sony PS5", 15, "", "", "Action", "", "", "God of War", "SIE Santa Monica Studio", "Standard Edition", "M", "PS5", "Sony", "30-Day Limited Warranty", "God of War Ragnarök", "English, Spanish, Portuguese", 91, "Physical", false, true, true, 1, 1, "Spanish, English, Portuguese", "Spanish, English, Portuguese", "V", "PS5", "Ps5", 60 }
                });

            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "Id", "DataObjectValue_ReleaseMonth", "DataObjectValue_ReleaseYear", "FlagsObjectValue_IsBestSeller", "FlagsObjectValue_IsFavorite", "PriceObjectValue_HistoryPrice", "PriceObjectValue_Price", "SpecificationObjectValue_Brand", "SpecificationObjectValue_Line", "SpecificationObjectValue_Model", "SpecificationObjectValue_Type", "SpecificationObjectValue_Weight", "WarrantyObjectValue_WarrantyInformation", "WarrantyObjectValue_WarrantyLength", "MainFeaturesObjectValue_FabricDesign", "MainFeaturesObjectValue_TypeOfClothing", "OtherFeaturesObjectValue_Composition", "OtherFeaturesObjectValue_ItsSporty", "OtherFeaturesObjectValue_MainMaterial", "OtherFeaturesObjectValue_UnitsPerKit", "OtherFeaturesObjectValue_WithRecycledMaterials", "CategoryId", "Description", "Discriminator", "ImagesUrl", "Name", "Stock", "CommonPropertiesObjectValue_Age", "CommonPropertiesObjectValue_Color", "CommonPropertiesObjectValue_Gender", "CommonPropertiesObjectValue_RecommendedUser", "CommonPropertiesObjectValue_Size" },
                values: new object[] { 7, "June", 2023, true, true, 0.0m, 16.99m, "Nike", "", "Nike T-Shirt", "T-Shirt", "200 g", "15-Day Limited Warranty", "1-year warranty", "Straight", "T-shirt", "Polyester", false, "", 1, false, 2, "The Nike Classic Swoosh Future medium support women's workout top offers long-lasting comfort during training with sweat-wicking fabric and a compression fit.", "Shirt", "[\"https://imgnike-a.akamaihd.net/768x768/002897ID.jpg\",\"https://imgnike-a.akamaihd.net/768x768/002897IDA1.jpg\",\"https://imgnike-a.akamaihd.net/768x768/002897IDA4.jpg\",\"https://imgnike-a.akamaihd.net/768x768/002897IDA5.jpg\"]", "Top Nike Swoosh Woman", 5, "Adult", "Black", "Woman", "Casual", "S" });

            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "Id", "DataObjectValue_ReleaseMonth", "DataObjectValue_ReleaseYear", "FlagsObjectValue_IsDailyOffer", "PriceObjectValue_HistoryPrice", "PriceObjectValue_Price", "SpecificationObjectValue_Brand", "SpecificationObjectValue_Line", "SpecificationObjectValue_Model", "SpecificationObjectValue_Type", "SpecificationObjectValue_Weight", "WarrantyObjectValue_WarrantyInformation", "WarrantyObjectValue_WarrantyLength", "MainFeaturesObjectValue_FabricDesign", "MainFeaturesObjectValue_TypeOfClothing", "OtherFeaturesObjectValue_Composition", "OtherFeaturesObjectValue_ItsSporty", "OtherFeaturesObjectValue_MainMaterial", "OtherFeaturesObjectValue_UnitsPerKit", "OtherFeaturesObjectValue_WithRecycledMaterials", "CategoryId", "Description", "Discriminator", "ImagesUrl", "Name", "Stock", "CommonPropertiesObjectValue_Age", "CommonPropertiesObjectValue_Color", "CommonPropertiesObjectValue_Gender", "CommonPropertiesObjectValue_RecommendedUser", "CommonPropertiesObjectValue_Size" },
                values: new object[] { 8, "March", 2023, true, 80.0m, 64.99m, "Adidas", "", "JACKET Adidas", "T-Shirt", "350 g", "15-Day Limited Warranty", "1-year warranty", "Straight", "T-shirt", "", true, "Cotton", 1, false, 2, "Fresh and full of life, this Adi color Firebird track jacket celebrates the power and authenticity of adidas' legendary DNA.", "Shirt", "[\"https://assets.adidas.com/images/h_840,f_auto,q_auto,fl_lossy,c_fill,g_auto/a5757a66a549439cbac6afcd002ca57f_9366/Adicolor_Classics_Firebird_Track_Jacket_Black_IL8764_01_laydown.jpg\",\"https://assets.adidas.com/images/h_840,f_auto,q_auto,fl_lossy,c_fill,g_auto/3cae025992434e889496afcd002c97ae_9366/Adicolor_Classics_Firebird_Track_Jacket_Black_IL8764_42_detail.jpg\",\"https://assets.adidas.com/images/h_840,f_auto,q_auto,fl_lossy,c_fill,g_auto/c6f0e6def4bd4eefa0bfafcd002c7094_9366/Adicolor_Classics_Firebird_Track_Jacket_Black_IL8764_21_model.jpg\",\"https://assets.adidas.com/images/h_840,f_auto,q_auto,fl_lossy,c_fill,g_auto/a915172e29f24ce4b34bafcd002c78dc_9366/Adicolor_Classics_Firebird_Track_Jacket_Black_IL8764_23_hover_model.jpg\"]", "Adi color classics firebird track jacket", 8, "Adult", "Black", "Woman", "Casual", "XS" });

            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "Id", "DataObjectValue_ReleaseMonth", "DataObjectValue_ReleaseYear", "FlagsObjectValue_IsDailyOffer", "FlagsObjectValue_IsFavorite", "PriceObjectValue_HistoryPrice", "PriceObjectValue_Price", "SpecificationObjectValue_Brand", "SpecificationObjectValue_Line", "SpecificationObjectValue_Model", "SpecificationObjectValue_Type", "SpecificationObjectValue_Weight", "WarrantyObjectValue_WarrantyInformation", "WarrantyObjectValue_WarrantyLength", "MaterialObjectValue_MaterialFromAbroad", "MaterialObjectValue_MaterialInterior", "MaterialObjectValue_MaterialSole", "CategoryId", "Description", "Discriminator", "ImagesUrl", "Name", "Stock", "CommonPropertiesObjectValue_Age", "CommonPropertiesObjectValue_Color", "CommonPropertiesObjectValue_Gender", "CommonPropertiesObjectValue_RecommendedUser", "CommonPropertiesObjectValue_Size" },
                values: new object[] { 9, "June", 2023, true, true, 95.0m, 71.99m, "Nike", "SB", "DM3493", "Shoes", "368,5 g", "45-Day Limited Warranty", "1-year warranty", "Leather", "Cotton", "Rubber", 2, "Buoyed to the comfort you've come to trust, the Air Max Excee meets the needs of your 9 to 5 while keeping your outfit on-point with rich textures. These sneakers deliver just what you're looking for—soft cushioning that's easy to style.", "Shoes", "[\"https://static.nike.com/a/images/c_limit,w_592,f_auto/t_product_v1/24d5a5ec-db76-4512-99a8-36231b9a9b41/streakfly-road-racing-shoes-8rTxtR.png\",\"https://static.nike.com/a/images/t_PDP_1728_v1/f_auto,q_auto:eco/97fb810e-5803-43f5-98ac-67c8763deb15/streakfly-road-racing-shoes-8rTxtR.png\",\"https://static.nike.com/a/images/t_PDP_1728_v1/f_auto,q_auto:eco/6d25c69b-b08b-4cc7-b97d-8384e196951f/streakfly-road-racing-shoes-8rTxtR.png\",\"https://static.nike.com/a/images/t_PDP_1728_v1/f_auto,q_auto:eco/54e264aa-a85f-4152-b409-ed0372924d81/streakfly-road-racing-shoes-8rTxtR.png\"]", "Nike Streak-fly", 15, "Adult", "Pink/Gold and Black", "Woman", "skateboarding", "7.5" });

            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "Id", "DataObjectValue_ReleaseMonth", "DataObjectValue_ReleaseYear", "FlagsObjectValue_IsBestSeller", "FlagsObjectValue_IsFavorite", "PriceObjectValue_HistoryPrice", "PriceObjectValue_Price", "SpecificationObjectValue_Brand", "SpecificationObjectValue_Line", "SpecificationObjectValue_Model", "SpecificationObjectValue_Type", "SpecificationObjectValue_Weight", "WarrantyObjectValue_WarrantyInformation", "WarrantyObjectValue_WarrantyLength", "MaterialObjectValue_MaterialFromAbroad", "MaterialObjectValue_MaterialInterior", "MaterialObjectValue_MaterialSole", "CategoryId", "Description", "Discriminator", "ImagesUrl", "Name", "Stock", "CommonPropertiesObjectValue_Age", "CommonPropertiesObjectValue_Color", "CommonPropertiesObjectValue_Gender", "CommonPropertiesObjectValue_RecommendedUser", "CommonPropertiesObjectValue_Size" },
                values: new object[] { 10, "October", 2022, true, true, 0.0m, 75.99m, "Puma", "SB", "Basketball Classic XXI sneakers", "Shoes", "368,5 g", "45-Day Limited Warranty", "1-year warranty", "Leather", "Cotton", "Rubber", 2, "The Suede hit the scene in 1968 and has been changing the game ever since. It’s been worn by icons of every generation, and it’s stayed classic through it all. Instantly recognizable and constantly reinvented, Suede’s legacy continues to grow and be legitimized by the authentic and expressive individuals that embrace the iconic shoe. Be apart of the history of Suede.", "Shoes", "[\"https://images.puma.com/image/upload/f_auto,q_auto,b_rgb:fafafa,w_600,h_600/global/374915/01/sv01/fnd/PNA/fmt/png/Suede-Classic-XXI-Sneakers\",\"https://images.puma.com/image/upload/f_auto,q_auto,b_rgb:fafafa,w_600,h_600/global/374915/01/mod02/fnd/PNA/fmt/png/Suede-Classic-XXI-Sneakers\",\"https://images.puma.com/image/upload/f_auto,q_auto,b_rgb:fafafa,w_600,h_600/global/374915/01/mod03/fnd/PNA/fmt/png/Suede-Classic-XXI-Sneakers\",\"https://images.puma.com/image/upload/f_auto,q_auto,b_rgb:fafafa,w_600,h_600/global/374915/01/bv/fnd/PNA/fmt/png/Suede-Classic-XXI-Sneakers\"]", "Suede Classic XXI Sneakers", 15, "Adult", "Black", "Man", "skateboarding", "7.5" });

            migrationBuilder.InsertData(
                table: "Reviews",
                columns: new[] { "Id", "Comment", "Image", "ProductId", "Rating", "ReviewDate" },
                values: new object[,]
                {
                    { 1, "The quality of the photos is incredible.", "https://http2.mlstatic.com/D_NQ_NP_637616-MLA70484274053_072023-O.webp", 1, 5, new DateTime(2025, 2, 2, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 2, "Very good purchase, it arrived very quickly and it arrived like a totally new phone, it only has very slight details on the sides.", "https://m.media-amazon.com/images/I/71a4vqXqxbL._SY256.jpg", 1, 5, new DateTime(2025, 2, 2, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 3, "Good!", "https://http2.mlstatic.com/D_NQ_NP_2X_743184-MLA69501979268_052023-F.webp", 1, 4, new DateTime(2025, 2, 2, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 4, "The best smartphone I've ever used!!! I left an iPhone 14 Pro Max, sold it, bought the S23 Ultra and still had money left. There's no comparison, with 8gb of ram you can use several applications in the background at the same time.", "https://http2.mlstatic.com/D_NQ_NP_2X_936910-MLA54765476953_032023-F.webp", 2, 5, new DateTime(2025, 2, 2, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 5, "Excellent, after all it is an Apple product. Worth every penny given ❤.", "https://http2.mlstatic.com/D_NQ_NP_2X_960098-MLA73264672831_122023-F.webp", 3, 5, new DateTime(2025, 2, 2, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 6, "The best.", "https://http2.mlstatic.com/D_NQ_NP_2X_911842-MLA73095448948_112023-F.webp", 4, 4, new DateTime(2025, 2, 2, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 7, "New original product you can buy without fear!.", "https://http2.mlstatic.com/D_NQ_NP_2X_696237-MLA71736945652_092023-F.webp", 5, 5, new DateTime(2025, 2, 2, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 8, "Excellent product, came sealed.", "https://http2.mlstatic.com/D_NQ_NP_2X_918056-MLA72166744514_102023-F.webp", 5, 5, new DateTime(2025, 2, 2, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 9, "Perfect product.", "https://http2.mlstatic.com/D_NQ_NP_2X_661229-MLA72108620029_102023-F.webp", 6, 5, new DateTime(2025, 2, 2, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 10, "The best product, very good!", "https://http2.mlstatic.com/D_NQ_NP_2X_942915-MLA54965635426_042023-F.webp", 6, 4, new DateTime(2025, 2, 2, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 11, "Pay attention to size. Nike models are smaller. The ideal is to buy 1 size larger.", "", 7, 4, new DateTime(2025, 2, 2, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 12, "It was small on me. I want to return it. To get my refund.", "", 7, 1, new DateTime(2025, 2, 2, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 13, "Excellent product.", "", 9, 5, new DateTime(2025, 2, 2, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 14, "I liked the original, it has to be laced but it's perfect.", "", 10, 5, new DateTime(2025, 2, 2, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 15, "I'm a fan of this sneaker. One of the most beautiful on the foot, in my opinion.", "", 10, 4, new DateTime(2025, 2, 2, 0, 0, 0, 0, DateTimeKind.Unspecified) }
                });
